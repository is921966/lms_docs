...
v3 - с оптимизацией размера скриншотов для GitHub
"""
...
def index():
    ...
    <head>
        ...
        <style>
            ...
            .screenshot-preview { max-width: 300px; max-height: 200px; margin-top: 10px; border-radius: 8px; cursor: pointer; }
    ...
    <body>
        <div class="container">
            ...
            <p>Railway Production Server - v3 with Optimized Screenshots</p>
...
def health():
    ...
    return jsonify({
        'status': 'healthy',
        'server': 'Railway Feedback Server v3',
        'timestamp': datetime.now().isoformat(),
        'github_configured': bool(CONFIG['github']['token']),
        'feedback_count': len(FEEDBACK_STORAGE),
        'version': '3.0.0',
        'features': ['base64-screenshots', 'github-integration', 'screenshot-optimization']
    })
...
print(f"""
🚀 LMS Feedback Server (Railway Edition v3) Initialized!
==========================================================
